...
function BlueprintSpriteMarker({ src }: { src: string }) {
  return (
...
function BlueprintLetterMarker({ value }: { value: string }) {
  return (
...
export interface BlueprintLegendProps {
  t: (key: string) => string;
}

export default function BlueprintLegend({ t }: BlueprintLegendProps) {
  return (
